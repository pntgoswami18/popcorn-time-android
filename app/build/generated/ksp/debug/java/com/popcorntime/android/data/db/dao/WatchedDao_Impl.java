...
public final class WatchedDao_Impl implements WatchedDao {
  ...
  public WatchedDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfWatchedEntity = new EntityInsertionAdapter<WatchedEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `watched` (`imdbId`,`watchedAt`) VALUES (?,?)";
      }
    ...
    this.__preparedStmtOfDelete = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM watched WHERE imdbId = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object insert(final WatchedEntity entity, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfWatchedEntity.insert(entity);
  ...
  public Flow<List<String>> observeAll() {
    final String _sql = "SELECT imdbId FROM watched";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"watched"}, new Callable<List<String>>() {
      @Override
      @NonNull
  ...
  @Override
  public Object isWatched(final String imdbId, final Continuation<? super Boolean> $completion) {
    final String _sql = "SELECT EXISTS(SELECT 1 FROM watched WHERE imdbId = ?)";
